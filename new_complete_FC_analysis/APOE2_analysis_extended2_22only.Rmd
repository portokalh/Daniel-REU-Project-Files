...
mastersheet <- read.csv('/Users/alex/AlexBadea_MyCodes/daniel_sun_jin/Daniel-REU-Project-Files-main_final/new_complete_FC_analysis/animal_info.csv')
setwd('/Users/alex/AlexBadea_MyCodes/daniel_sun_jin/Daniel-REU-Project-Files-main_final/new_complete_FC_analysis/FC_Data_7-7-22_Complete/')

batch1_0 <- read.csv('1. FC Batch Report 201026 (CTRL_18_201026)/Batch_day0_201026_15Motionthreshold_10_minfreezeduration.csv', skip=16)
batch1_1 <- read.csv('1. FC Batch Report 201026 (CTRL_18_201026)/Batch_day1_211026_15Motionthreshold_10_minfreezeduration.csv', skip=11)
batch1_2 <- read.csv('1. FC Batch Report 201026 (CTRL_18_201026)/Batch_day2_211026_15Motionthreshold_10_minfreezeduration.csv', skip=13)

batch2_0 <- read.csv('2. FC Batch Report 210118 (HFD_201012)/Batch_day0_210118_15Motionthreshold_10_minfreezeduration.csv', skip=16)
batch2_1 <- read.csv('2. FC Batch Report 210118 (HFD_201012)/Batch_day1_210118_15Motionthreshold_10_minfreezeduration.csv', skip=11)
batch2_2 <- read.csv('2. FC Batch Report 210118 (HFD_201012)/Batch_day2_210118_15Motionthreshold_10_minfreezeduration.csv', skip=13)

batch3_0 <- read.csv('3. FC Batch Report 210212 (Jan Mixed)/Batch_day0_210212_15Motionthreshold_10_minfreezeduration.csv', skip=16)
batch3_1 <- read.csv('3. FC Batch Report 210212 (Jan Mixed)/Batch_day1_210222_15Motionthreshold_10_minfreezeduration.csv', skip=11)
batch3_2 <- read.csv('3. FC Batch Report 210212 (Jan Mixed)/Batch_day2_210212_15Motionthreshold_10_minfreezeduration.csv', skip=13)

batch4_0 <- read.csv('4. FC Batch Report 210201 (CTRL_12_210201)/Batch_day0_210201_15Motionthreshold_10_minfreezeduration.csv', skip=16)
batch4_1 <- read.csv('4. FC Batch Report 210201 (CTRL_12_210201)/Batch_day1_210201_15Motionthreshold_10_minfreezeduration.csv', skip=11)
batch4_2 <- read.csv('4. FC Batch Report 210201 (CTRL_12_210201)/Batch_day2_210201_15Motionthreshold_10_minfreezeduration.csv', skip=13)

batch5_0 <- read.csv('5. FC Batch Report 210222 (CTRL_12_210222)/Batch_day0_210222_15Motionthreshold_10_minfreezeduration.csv', skip=16)
batch5_1 <- read.csv('5. FC Batch Report 210222 (CTRL_12_210222)/Batch_day1_210222_15Motionthreshold_10_minfreezeduration.csv', skip=11)
batch5_2 <- read.csv('5. FC Batch Report 210222 (CTRL_12_210222)/Batch_day2_210222_15Motionthreshold_10_minfreezeduration.csv', skip=13)

batch6_0 <- read.csv('6. Fc Batch Report 210503 (CTRL_12_18_210624)/Batch_day0_210503_15Motionthreshold_10_minfreezeduration.csv', skip=16)
batch6_1 <- read.csv('6. Fc Batch Report 210503 (CTRL_12_18_210624)/Batch_day1_210503_15Motionthreshold_10_minfreezeduration.csv', skip=11)
batch6_2 <- read.csv('6. Fc Batch Report 210503 (CTRL_12_18_210624)/Batch_day2_210503_15Motionthreshold_10_minfreezeduration.csv', skip=13)

batch7_0 <- read.csv('7. FC Batch Report 210614  (March Mixed)/Batch_day0_210614_15Motionthreshold_10_minfreezeduration.csv', skip=16)
batch7_1 <- read.csv('7. FC Batch Report 210614  (March Mixed)/Batch_day1_210614_15Motionthreshold_10_minfreezeduration.csv', skip=11)
batch7_2 <- read.csv('7. FC Batch Report 210614  (March Mixed)/Batch_day2_210614_15Motionthreshold_10_minfreezeduration.csv', skip=13)

batch8_0 <- read.csv('8. FC Batch Report 210809  (August Mixed)/Batch_day0_210809_15Motionthreshold_10_minfreezeduration.csv', skip=16)
batch8_1 <- read.csv('8. FC Batch Report 210809  (August Mixed)/Batch_day1_210809_15Motionthreshold_10_minfreezeduration.csv', skip=11)
batch8_2 <- read.csv('8. FC Batch Report 210809  (August Mixed)/Batch_day2_210809_15Motionthreshold_10_minfreezeduration.csv', skip=13)

batch9_0 <- read.csv('9. FC Batch Report 210906  (Sept Mixed)/Batch_day0_210906_SeptMixed_15Motionthreshold_10minfreezeduration.csv', skip=16)
batch9_1 <- read.csv('9. FC Batch Report 210906  (Sept Mixed)/Batch_day1_210906_SeptMixed_15Motionthreshold_10minfreezeduration.csv', skip=11)
batch9_2 <- read.csv('9. FC Batch Report 210906  (Sept Mixed)/Batch_day2_210906_SeptMixed_15Motionthreshold_10minfreezeduration.csv', skip=13)

batch10_0 <- read.csv('10. FC Batch Report 21104 (Oct Mixed)/Batch_day0_211004OctMixed_15Motionthreshold_10minfreezeduration.csv', skip=16)
batch10_1 <- read.csv('10. FC Batch Report 21104 (Oct Mixed)/Batch_day1_211004OctMixed_15Motionthreshold_10minfreezeduration.csv', skip=11)
batch10_2 <- read.csv('10. FC Batch Report 21104 (Oct Mixed)/Batch_day2_211004OctMixed_15Motionthreshold_10minfreezeduration.csv', skip=13)

batch11_0 <- read.csv('11. FC Batch Report 211122 Nov Mixed/Batch_day0_211122NovMixed_15Motionthreshold_10minfreezeduration.csv', skip=16)
batch11_1 <- read.csv('11. FC Batch Report 211122 Nov Mixed/Batch_day1_211122NovMixed_15Motionthreshold_10minfreezeduration.csv', skip=11)
batch11_2 <- read.csv('11. FC Batch Report 211122 Nov Mixed/Batch_day2_211122NovMixed_15Motionthreshold_10minfreezeduration.csv', skip=13)

batch12_0 <- read.csv('12. FC Batch Report 220110 (Jan2022 Mixed)/Batch_day0_220110JanMix_15MotionThreshold_10MinFreezeDuration.csv', skip=16)
batch12_1 <- read.csv('12. FC Batch Report 220110 (Jan2022 Mixed)/Batch_day1_220110JanMix_15MotionThreshold_10MinFreezeDuration.csv', skip=11)
batch12_2 <- read.csv('12. FC Batch Report 220110 (Jan2022 Mixed)/Batch_day2_220110JanMix_15MotionThreshold_10MinFreezeDuration.csv', skip=13)

batch13_0 <- read.csv('13. FC Batch Report 220207 (Feb2022 18mnth)/Batch_Day0_220207Feb2022_15MotionThreshold_10Minfreezeduration.csv', skip=16)
batch13_1 <- read.csv('13. FC Batch Report 220207 (Feb2022 18mnth)/Batch_Day1_220207Feb2022_15MotionThreshold_10Minfreezeduration.csv', skip=11)
batch13_2 <- read.csv('13. FC Batch Report 220207 (Feb2022 18mnth)/Batch_Day2_220207Feb2022_15MotionThreshold_10Minfreezeduration.csv', skip=13)

batch14_0 <- read.csv('14. FC Batch Report 220307 (March22_18moCtrl)/Batch_Day0_220307March2022_15MotionThreshold_10minfreezeduration.csv', skip=16)
batch14_1 <- read.csv('14. FC Batch Report 220307 (March22_18moCtrl)/Batch_Day1_220307March2022_15MotionThreshold_10minfreezeduration.csv', skip=11)
batch14_2 <- read.csv('14. FC Batch Report 220307 (March22_18moCtrl)/Batch_Day2_220307March2022_15MotionThreshold_10minfreezeduration.csv', skip=13)

batch15_0 <- read.csv('15. FC Batch Report 220404 (April2022_Mixed)/Batch_day0_220404_April2022_15motionthreshold_10minfreezeduration.csv', skip=16)
batch15_1 <- read.csv('15. FC Batch Report 220404 (April2022_Mixed)/Batch_day1_220404_April2022_15motionthreshold_10minfreezeduration.csv', skip=11)
batch15_2 <- read.csv('15. FC Batch Report 220404 (April2022_Mixed)/Batch_day2_220404_April2022_15motionthreshold_10minfreezeduration.csv', skip=13)
 
batch16_0 <- read.csv('16. FC Batch Report 220509 (May2022_Mixed)/Batch_day0_220509_May2022_15motionthreshold_10minfreezeduration.csv', skip=16)
batch16_1 <- read.csv('16. FC Batch Report 220509 (May2022_Mixed)/Batch_day1_220509_May2022_15motionthreshold_10minfreezeduration.csv', skip=11)
batch16_2 <- read.csv('16. FC Batch Report 220509 (May2022_Mixed)/Batch_day2_220509_May2022_15motionthreshold_10minfreezeduration.csv', skip=13)

batch17_0 <- read.csv('17. FC Batch Report 220606 (June2022)/Batch_Day0_220606_June2022_15MotionThreshold_10MinFreezeDuration.csv', skip=16)
batch17_1 <- read.csv('17. FC Batch Report 220606 (June2022)/Batch_Day1_220606_June2022_15MotionThreshold_10MinFreezeDuration.csv', skip=11)
batch17_2 <- read.csv('17. FC Batch Report 220606 (June2022)/Batch_Day2_220606_June2022_15MotionThreshold_10MinFreezeDuration.csv', skip=13)
...
print('Mice count')
print(mice_count)
write.xlsx(as.data.frame(mice_count), file = 'fcstats.xlsx', sheet='subjects')
...
day0_all_ages_genotype_treatment <- day0_relevant_data %>%
  select( Sex, Treatment, Time, Pct.Total.Time.Freezing) %>%
  group_by( Treatment, Time, Sex) %>% 
  summarise(n=n(),
            se = sd(Pct.Total.Time.Freezing, na.rm=TRUE)/sqrt(n),
            len = mean(Pct.Total.Time.Freezing))
  
ggplot(data = day0_all_ages_genotype_treatment, aes(x = Time, y = len, color = Sex)) +
  geom_line() +
...
ggplot(data = day0_12_months_genotype_treatment, aes(x = Time, y = len, color = Sex)) +
  geom_line() +
  facet_grid(.~Treatment) + 
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
...
ggplot(data = day0_18_months_genotype_treatment, aes(x = Time, y = len, color = Sex)) +
  geom_line() +
  facet_grid(.~Treatment) + 
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
...
day0_12_months_nonHN_genotype_treatment <- day0_relevant_data %>%
  ...
  filter(Genotype == "APOE22" |
         Genotype == "APOE33" |
         Genotype == "APOE44") %>%
  select(Sex, Genotype, Treatment, Time, Pct.Total.Time.Freezing) %>%
  group_by(Sex, Genotype, Treatment, Time) %>% 
  summarise(n=n(),
            se = sd(Pct.Total.Time.Freezing, na.rm=TRUE)/sqrt(n),
            len = mean(Pct.Total.Time.Freezing))
  
ggplot(data = day0_12_months_nonHN_genotype_treatment, aes(x = Time, y = len, color = Sex)) +
  geom_line() +
  facet_grid(.~Treatment) + 
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
...
ggplot(data = day0_18_months_nonHN_genotype_treatment, aes(x = Time, y = len, color = Treatment)) +
  geom_line() +
  facet_grid(.~Treatment) + 
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
...
ggplot(data = day0_12_months_nonHNs_treatment_sex, aes(x = Time, y = len, color = Sex)) +
  geom_line() +
  facet_grid(.~Treatment)  + 
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
...
ggplot(data = day0_18_months_nonHNs_treatment_sex, aes(x = Time, y = len, color = Sex)) +
  geom_line() +
  facet_grid(.~Treatment)  + 
  geom_errorbar(aes(ymin = len - se, ymax = len + se), width = 0.2, size = 0.5) +
  theme_bw() + 
...
ggplot(data = day1_12_months_nonHN_genotype, aes(factor(Treatment), Pct.Total.Time.Freezing)) +
  geom_violin() +
  geom_boxplot(width = 0.1) +
  theme_bw() +
  #facet_grid(.~Treatment) + 
...
ggplot(data = day1_18_months_nonHN_genotype, aes(factor(Treatment), Pct.Total.Time.Freezing)) +
  geom_violin() +
  geom_boxplot(width = 0.1) +
  theme_bw() +
  #facet_grid(.~Treatment) + 
...
ggplot(data = day2_nonHN_genotype, aes(factor(Treatment), Pct.Total.Time.Freezing)) +
  geom_violin() +
  geom_boxplot(width = 0.1) +
  theme_bw() +
...
ggplot(data = day2_12_months_nonHN_genotype, aes(factor(Treatment), Pct.Total.Time.Freezing)) +
  geom_violin() +
  geom_boxplot(width = 0.1) +
  theme_bw() +
  facet_grid(Treatment~Component) + 
...
ggplot(data = day2_18_months_nonHN_genotype, aes(factor(Treatment), Pct.Total.Time.Freezing)) +
  geom_violin() +
  geom_boxplot(width = 0.1) +
  theme_bw() +
  facet_grid(Treatment~Component) + 
...
ggplot(data = day2_within_tone_nonHN_genotype, aes(factor(Treatment), Pct.Total.Time.Freezing)) +
  geom_violin() +
  geom_boxplot(width = 0.1) +
  theme_bw() +
...
library(rJava)
library(xlsx)
write.xlsx(anova(day0_lmer), file = 'fcstats.xlsx', sheet='day0', append=TRUE)
